...
function runGame(gameType) {
  ...
  if (gameType === "addition") {
    ...
    // For division, we'll generate numbers that will always result in a whole number
    // Calculate the dividend (result * divisor)
    let dividend = num1 * num2;
    displayDivisionQuestion(dividend, num1);
  } else {
